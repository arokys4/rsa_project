...
\section{Instrukcja użytkownika}
    ...
    Szczegółowa instrukcja obsługi programu, wraz z przykładami użycia interfejsu wiersza poleceń, została zamieszczona w pliku \texttt{README.md} w repozytorium projektu. Polska wersja językowa jest dostępna w pliku \texttt{README_PL.md}.
